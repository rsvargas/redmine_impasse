if Rails::VERSION::MAJOR < 3
  ...
  match 'projects/:project_id/impasse/test_case/(:action(/:id))', :controller => 'impasse_test_case', via: [:get, :post, :put, :patch, :delete]
  match 'projects/:project_id/impasse/test_plans/(:action(/:id))', :controller => 'impasse_test_plans', via: [:get, :post, :put, :patch, :delete]
  match 'projects/:project_id/impasse/executions/(:action(/:id))', :controller => 'impasse_executions', via: [:get, :post, :put, :patch, :delete]
  match 'projects/:project_id/impasse/execution_bugs/(:action(/:id))', :controller => 'impasse_execution_bugs', via: [:get, :post, :put, :patch, :delete]
  match 'projects/:project_id/impasse/settings/(:action(/:id))', :controller => 'impasse_settings', via: [:get, :post, :put, :patch, :delete]
  match 'projects/:project_id/impasse/requirement_issues/(:action(/:id))', :controller => 'impasse_requirement_issues', via: [:get, :post, :put, :patch, :delete]
  ...
  match 'projects/:project_id/impasse/screenshots/(:action/(:id))', :controller => 'impasse_screenshots', via: [:get, :post, :put, :patch, :delete]
